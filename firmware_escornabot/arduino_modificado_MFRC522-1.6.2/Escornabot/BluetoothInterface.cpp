...
//////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////
void BluetoothInterface::CardNotDetected()
{
    _config->serial->print("Z");
    _config->serial->print(NL);
...
//////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////
void BluetoothInterface::MatchingCard(uint8_t result)
{
    if (result == 1)
      _config->serial->print("X");
    else
      _config->serial->print("Y");
